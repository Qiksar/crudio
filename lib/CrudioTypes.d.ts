...
export declare enum CrudioSort {
    Ascending = "asc",
    Descending = "desc"
}
export declare enum CrudioWhere {
    Like = "_like",
    iLike = "_ilike",
    NotLike = "_nlike",
    iNotLike = "_nilike",
...
export interface ICrudioEntityType {
    ...
    AddField(fieldName: string, fieldType: string, caption?: string, options?: ICrudioFieldOptions): ICrudioEntityType;
    AddGraphField(entityName: string, fieldList: string, fieldOptions?: ICrudioFieldOptions): ICrudioEntityType;
    AddRelation(sourceColumn: string, target: CrudioEntityType, targetColumn: string, name: string): ICrudioEntityType;
    AddKey(fieldName: string, fieldType?: string): ICrudioEntityType;
    AddString(fieldName: string, caption?: string, options?: ICrudioFieldOptions): ICrudioEntityType;
    AddNumber(fieldName: string, caption?: string, options?: ICrudioFieldOptions): ICrudioEntityType;
    AddBoolean(fieldName: string, caption?: string, options?: ICrudioFieldOptions): ICrudioEntityType;
    AddDate(fieldName: string, caption?: string, options?: ICrudioFieldOptions): ICrudioEntityType;
...
export interface ICrudioQuery {
    ...
    limit?: number;
    offset?: number;
    Where(fieldName: string, filterType: CrudioWhere, filterValue: string): ICrudioQuery;
